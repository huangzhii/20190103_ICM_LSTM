...
def parse_args():
    ...
    parser.add_argument('--results_dir', default='/home/zhihuan/Documents/20181207_Hypoxemia/20190103_ICM_LSTM/Results/LSTM_20190104_16_1', help="results dir")
...
#            os.makedirs(results_dir_dataset + '/find_hyperparameters')
        ...
        #     Model
        # =============================================================================
        model = LSTM.LSTM(input_size = 43, hidden_size = 16, num_layers = 1, batch_size = batch_size, num_classes = 2, device = device)
