...
def parse_args():
    ...
    parser.add_argument('--gap', default=3, type=int)
    parser.add_argument('--results_dir', default='/home/zhihuan/Documents/20181207_Hypoxemia/20190103_ICM_LSTM/Results/20180107 data: 42 features normalized (hyperparameter)/Traditional_20190107_normalized', help="results dir")
...
if __name__=='__main__':
    ...
    mtds = ["logit_l1", "logit_l2", "NN", "NN_l2"]
